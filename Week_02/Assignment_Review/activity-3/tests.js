...
console.group("Unit Tests - isTheSameObjectShallow");
{
    kenzieAssert({
        ...
        failureMessage:
            "isTheSameObjectShallow is true if the object is the same",
    });
    kenzieAssert({
        actual: isTheSameObjectShallow(car1, car2),
        expected: false,
        testNumber: 2,
        testFunction: "isTheSameObjectShallow",
        failureMessage:
            "isTheSameObjectShallow is false if the object is not exactly the same",
    });
    kenzieAssert({
        actual: isTheSameObjectShallow(car1, car3),
        expected: false,
        testNumber: 3,
        testFunction: "isTheSameObjectShallow",
        failureMessage:
            "isTheSameObjectShallow is false if the object are completely different",
    });
    kenzieAssert({
        actual: isTheSameObjectShallow(car1, {
            make: "Ford",
            model: "Focus",
            year: 2002,
            numDoors: 2,
        ...
        testFunction: "isTheSameObjectShallow",
        failureMessage:
            "isTheSameObjectShallow is false if similar objects do not reference the same memory location",
    });
}
console.groupEnd();
...
console.group("Unit Tests - haveSameStructure");
{
    ...
    kenzieAssert({
        ...
        testFunction: "haveSameStructure",
        failureMessage:
            "haveSameStructure is true even if keys are out of order",
    });
    kenzieAssert({
        actual: haveSameStructure(
            {
...
console.group("Unit Tests - isTheSameObjectDeep");
{
    ...
    kenzieAssert({
        ...
        testFunction: "isTheSameObjectDeep",
        failureMessage:
            "isTheSameObjectDeep is true even if keys are out of order",
    });
    kenzieAssert({
        actual: isTheSameObjectDeep(
            {
